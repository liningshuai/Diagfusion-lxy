...
# demo样例
demopath = 'C:/Users/Administrator/Desktop/data/trace_demo.csv'
...
dataset = 'gaia'  # 或者 '20aiops'
trace_pairs_path = None  # 如果不需要，可以设置为 None

invocation_event = InvocationEvent(demo_labels, data_dir, dataset, trace_pairs_path)
invocation_event.get_invocation_events()
invocation_event.save_res('your_output_filename.json')
